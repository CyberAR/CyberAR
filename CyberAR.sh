...
echo -e  "Tools    : CyberAR $white         " |lolcat
echo -e  "Creadby  : CyberAR $white   " |lolcat
echo -e  "Team  : Silent Attack $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : CyberAR " | lolcat
exit
;;
